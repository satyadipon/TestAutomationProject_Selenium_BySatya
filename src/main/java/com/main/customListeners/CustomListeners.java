package com.main.customListeners;
...
import com.main.utils.TestUtils;
...
public class CustomListeners extends TestSetUp implements ITestListener, ISuiteListener {
	...
	public void onTestFailure(ITestResult arg0) {
		...
		if(arg0.getThrowable().getMessage().equals(null))
			exceptionMessage = arg0.getThrowable().getClass().toString();
			else
			exceptionMessage = arg0.getThrowable().getMessage();
			
			System.out.println(exceptionMessage);
			exceptionMessage = exceptionMessage + System.lineSeparator() + Arrays.toString(arg0.getThrowable().getStackTrace());
